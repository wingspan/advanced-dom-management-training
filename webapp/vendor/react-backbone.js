    ...
    React.BackboneMixin = {
        componentDidMount: function(domNode) {
            ...
            if (model instanceof Backbone.Collection) {
                model.on('add remove reset', _.bind(this.forceUpdate, this, _.identity), this);
            }
            else if (model) {
                var changeOptions = this.changeOptions || "change";
                var cb = !!this.onModelChange
                    ? _.bind(this.onModelChange, this)
                    : _.bind(this.forceUpdate, this, _.identity);
                model.on(changeOptions, cb);
            }
        },
